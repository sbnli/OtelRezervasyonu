<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonnelSign.aspx.cs" Inherits="OtelRezervasyonu.PersonnelSign" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="auto-style1" style="background-image: url('http://localhost:57121/Resimler/kayıt.jpg')">
            ...
            <tr>
                ...
                <td class="auto-style3">&nbsp;</td>
                <td>
                    <asp:Button ID="btkaydet" runat="server" OnClick="btkaydet_Click" style="height: 26px" Text="Sign Up" />
                </td>
            </tr>
            <tr>
                <td class="auto-style2">&nbsp;</td>
